...
def fill_barPs_scaled(n, d, xi, P, OMM, M, bar_xi, bar_P, bar_Pm, bar_Pm1, bar_M, em_Mu, en_Mp, en_Mc, Lmax):
    # 対角線 d の全てを埋める: bar_P, bar_Pm, bar_Pm1
    return 

def fill_barM_scaled(n, d, xi, P, OMM, M, bar_xi, bar_P, bar_M, em_Mu, en_Mp, en_Mc, Lmax):
    # 対角線 d の全てを埋める
    return 
...
def outside(n, xi, P, OMM, M, en_Mu, en_Mp, en_Mc, Lmax):
    ...
    for d in range(n - 1, 0, -1): # jax.lax.scan などを使う
       ...
       fill_barPs_scaled(n, d, xi, P, OMM, M, bar_xi, bar_P, bar_Pm, bar_Pm1, bar_M, em_Mu, en_Mp, en_Mc, Lmax)
       fill_barM_scaled(n, d, xi, P, OMM, M, bar_xi, bar_P, bar_M, em_Mu, en_Mp, en_Mc, Lmax)
